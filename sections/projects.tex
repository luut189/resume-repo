...
\resumeItemListStart
\resumeItem{Built \textbf{Kyzen}, a 2D Java game engine with batch rendering, ECS architecture, and texture atlas support, improving performance by \textbf{60\%} for \textbf{1000+} objects per frame.}
